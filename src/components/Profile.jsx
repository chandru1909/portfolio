            ...
            <div className="row align-items-center">
                ...
                <div className="col-md-7 mt-md-0 mt-3 order-md-2 order-1 py-4">
                    <div className="d-flex justify-content-between">
                        <div className='bg-yellow w-fit-content m-auto h-500px rounded-4 slideleft'>
                            <img className='ms-auto w-100 h-500px rounded-4 p-2 alignment-img d-block' src={user} alt="male1" />
                        </div>
                        <div>
            ...
            <div className="row mx-2 py-md-4 py-0 pb-4 align-items-center">
                <div className="col-md-6">
                    <div className="position-relative">
                        ...
                        <img className='position-relative w-82  h-500px d-block' src={experience} alt="experience" />
